...
<font color="red" font-weight="bold">Update: Pre-reviewed (ARR) submissions and Findings articles</font>

<u>Pre-reviewed (ARR) submissions</u>:
Please submit the article through the **SoftConf** platform.
The title of the submission should start with [ARR], and the submission file should contain both the article **and** the ARR reviews.

<u>Findings articles</u>:
Our workshop also offers the opportunity for researchers with **accepted Findings** articles to present their work.
Please send us the article per **email** (fieldmattersworkshop@gmail.com) with the PDF. Acceptance for presentation will be based on the relevance to the workshop topics.
The deadline to submit the accepted Findings articles is **January 20, 2026**, and the notification of acceptance is on January 23, 2026. 

#### Important dates:
<font color="red" font-weight="bold">deadline extended!</font>
+ Direct Submission deadline: ~~December 19, 2025~~ January 8, 2026
+ Pre-reviewed (ARR) submission deadline: ~~January 2, 2026~~ January 10, 2026
